...
namespace SpacetimeDB
{
	public partial class ChatMessage : IDatabaseTable
	{
		...
		public delegate void InsertEventHandler(ChatMessage insertedValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void UpdateEventHandler(ChatMessage oldValue, ChatMessage newValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void DeleteEventHandler(ChatMessage deletedValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void RowUpdateEventHandler(SpacetimeDBClient.TableOp op, ChatMessage oldValue, ChatMessage newValue, SpacetimeDB.ReducerEvent dbEvent);
