...
namespace SpacetimeDB
{
	public partial class MobileEntityComponent : IDatabaseTable
	{
		...
		public delegate void InsertEventHandler(MobileEntityComponent insertedValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void UpdateEventHandler(MobileEntityComponent oldValue, MobileEntityComponent newValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void DeleteEventHandler(MobileEntityComponent deletedValue, SpacetimeDB.ReducerEvent dbEvent);
		public delegate void RowUpdateEventHandler(SpacetimeDBClient.TableOp op, MobileEntityComponent oldValue, MobileEntityComponent newValue, SpacetimeDB.ReducerEvent dbEvent);
