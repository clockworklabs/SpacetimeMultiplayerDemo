...
namespace SpacetimeDB
{
	...
	{
		public static event Action<ClientApi.Event.Types.Status, Identity, ulong> OnToggleAcceptTradeEvent;

		public static void ToggleAcceptTrade(ulong participantEntityId)
		{
			var _argArray = new object[] {participantEntityId};
			var _message = new NetworkManager.ReducerCallRequest {
				fn = "toggle_accept_trade",
				args = _argArray,
			};
		...
		[ReducerEvent(FunctionName = "toggle_accept_trade")]
		public static void OnToggleAcceptTrade(ClientApi.Event dbEvent)
		{
			if(OnToggleAcceptTradeEvent != null)
			{
				...
				OnToggleAcceptTradeEvent(dbEvent.Status, Identity.From(dbEvent.CallerIdentity.ToByteArray()), args_0);
			}
		}
		[DeserializeEvent(FunctionName = "toggle_accept_trade")]
		public static object[] ToggleAcceptTradeDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			var bsatnBytes = dbEvent.FunctionCall.ArgBytes;
			using var ms = new System.IO.MemoryStream();
			ms.SetLength(bsatnBytes.Length);
