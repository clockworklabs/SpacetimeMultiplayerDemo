...
namespace SpacetimeDB
{
	...
	{
		public static event Action<ClientApi.Event.Types.Status, Identity, ulong, ulong> OnExtractEvent;
		...
		[ReducerEvent(FunctionName = "extract")]
		public static void OnExtract(ClientApi.Event dbEvent)
		{
			if(OnExtractEvent != null)
			{
				...
				OnExtractEvent(dbEvent.Status, Identity.From(dbEvent.CallerIdentity.ToByteArray()), args_0, args_1);
			}
		}
		[DeserializeEvent(FunctionName = "extract")]
		public static object[] ExtractDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			var bsatnBytes = dbEvent.FunctionCall.ArgBytes;
			using var ms = new System.IO.MemoryStream();
			ms.SetLength(bsatnBytes.Length);
