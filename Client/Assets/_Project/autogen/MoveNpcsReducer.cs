...
namespace SpacetimeDB
{
	...
	{
		public static event Action<ClientApi.Event.Types.Status, Identity, ulong> OnMoveNpcsEvent;

		public static void MoveNpcs(ulong prevTime)
		{
		...
		[ReducerEvent(FunctionName = "move_npcs")]
		public static void OnMoveNpcs(ClientApi.Event dbEvent)
		{
			if(OnMoveNpcsEvent != null)
			{
				...
				OnMoveNpcsEvent(dbEvent.Status, Identity.From(dbEvent.CallerIdentity.ToByteArray()), args_0);
			}
		}
		[DeserializeEvent(FunctionName = "move_npcs")]
		public static object[] MoveNpcsDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			var bsatnBytes = dbEvent.FunctionCall.ArgBytes;
			using var ms = new System.IO.MemoryStream();
			ms.SetLength(bsatnBytes.Length);
