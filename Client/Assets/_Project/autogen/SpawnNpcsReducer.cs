...
namespace SpacetimeDB
{
	...
	{
		public static event Action<ClientApi.Event.Types.Status, Identity, ulong> OnSpawnNpcsEvent;

		public static void SpawnNpcs(ulong prevTime)
		{
		...
		[ReducerEvent(FunctionName = "spawn_npcs")]
		public static void OnSpawnNpcs(ClientApi.Event dbEvent)
		{
			if(OnSpawnNpcsEvent != null)
			{
				...
				OnSpawnNpcsEvent(dbEvent.Status, Identity.From(dbEvent.CallerIdentity.ToByteArray()), args_0);
			}
		}
		[DeserializeEvent(FunctionName = "spawn_npcs")]
		public static object[] SpawnNpcsDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			var bsatnBytes = dbEvent.FunctionCall.ArgBytes;
			using var ms = new System.IO.MemoryStream();
			ms.SetLength(bsatnBytes.Length);
