	...
	public partial class Tree : IDatabaseTable
	{
		...
		public static SpacetimeDB.SATS.AlgebraicType GetAlgebraicType()
		{
			return SpacetimeDB.SATS.AlgebraicType.CreateProductType(new SpacetimeDB.SATS.ProductTypeElement[]
			{
				...
				new SpacetimeDB.SATS.ProductTypeElement("tree_idx", SpacetimeDB.SATS.AlgebraicType.CreatePrimitiveType(SpacetimeDB.SATS.BuiltinType.Type.U16)),
		...
		public static explicit operator Tree(SpacetimeDB.SATS.AlgebraicValue value)
		{
			if (value == null) {
				return null;
			}
			...
			return new Tree
			{
				...
				TreeIdx = productValue.elements[2].AsU16(),
