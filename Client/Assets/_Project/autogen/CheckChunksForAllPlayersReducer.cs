...
namespace SpacetimeDB
{
	...
	{
		public static event Action<ClientApi.Event.Types.Status, Identity, ulong> OnCheckChunksForAllPlayersEvent;

		public static void CheckChunksForAllPlayers(ulong prevTime)
		{
			var _argArray = new object[] {prevTime};
			var _message = new NetworkManager.ReducerCallRequest {
				fn = "check_chunks_for_all_players",
				args = _argArray,
			};
		...
		[ReducerEvent(FunctionName = "check_chunks_for_all_players")]
		public static void OnCheckChunksForAllPlayers(ClientApi.Event dbEvent)
		{
			if(OnCheckChunksForAllPlayersEvent != null)
			{
				...
				OnCheckChunksForAllPlayersEvent(dbEvent.Status, Identity.From(dbEvent.CallerIdentity.ToByteArray()), args_0);
			}
		}
		[DeserializeEvent(FunctionName = "check_chunks_for_all_players")]
		public static object[] CheckChunksForAllPlayersDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			var bsatnBytes = dbEvent.FunctionCall.ArgBytes;
			using var ms = new System.IO.MemoryStream();
			ms.SetLength(bsatnBytes.Length);
