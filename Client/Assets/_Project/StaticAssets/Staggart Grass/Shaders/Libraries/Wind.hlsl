...
struct WindSettings
{
	...
	float gustStrength;
	float gustFrequency;
	float pinningStrength;
	float pinningFirmness;
};

WindSettings PopulateWindSettings(in float strength, float speed, float4 direction, float swinging, float mask, 
	float randObject, float randVertex, float randObjectStrength, float gustStrength, float gustFrequency,
	float windPinningStrength, float windPinningFirmness)
{
	...
	s.pinningStrength = windPinningStrength;
	s.pinningFirmness = windPinningFirmness;
