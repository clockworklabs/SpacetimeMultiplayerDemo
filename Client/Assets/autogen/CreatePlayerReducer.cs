...
namespace SpacetimeDB.Types
{
	public static partial class Reducer
	{
		...
		public static void CreatePlayerDeserializeEventArgs(ClientApi.Event dbEvent)
		{
			...
			dbEvent.FunctionCall.CallInfo = new ReducerEvent(ReducerType.CreatePlayer, "create_player", dbEvent.Timestamp, Identity.From(dbEvent.CallerIdentity.ToByteArray()), dbEvent.Message, dbEvent.Status, args);
		}
	}
